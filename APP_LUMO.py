...
def renderizar_pagina_3(can):
    ...
    payback_anos = st.session_state.get('payback_anos', 0.0)
    payback_meses = st.session_state.get('payback_meses', 0.0)
    ...
    meses_restantes = int(round(payback_meses % 12))
    can.drawCentredString(441, 224, f"{int(anos_inteiros)} anos e")
    can.drawCentredString(441, 210, f"{meses_restantes} meses")
    ...
    try:
        ...
        if os.path.exists(caminho_fundo_p2):
            ...
            if sobra_modulos > 0:
                ...
                can.drawString(103, 512, f"de ampliar {sobra_modulos} Módulos")
