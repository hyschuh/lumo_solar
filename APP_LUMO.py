...
def renderizar_pagina_3(can):
    ...
    # --- NOVA LÓGICA DE PAYBACK (CORREÇÃO DE 12 MESES) ---
    total_meses_arredondado = int(round(payback_meses_total))

    # divmod divide por 12 e retorna (anos, meses_restantes)
    # Ex: 36 meses -> (3, 0) | 37 meses -> (3, 1)
    ...
    # Montagem das linhas para o PDF
...
def gerar_pdf_completo():
    ...
    try:
        ...
        if os.path.exists(caminho_fundo_p2):
            ...
            if logo: can.drawImage(logo, 20, 20, width=240, height=120, mask='auto', preserveAspectRatio=True)
            ...
            # --- LÓGICA DE SOBRA DE INVERSOR COM QUEBRA DE LINHA ---
            if sobra_modulos > 0:
            ...
            # GRÁFICO (PÁGINA 2) - USANDO MESMA LÓGICA DA TELA
            ordem_meses = ["JAN", "FEV", "MAR", "ABR", "MAI", "JUN", "JUL", "AGO", "SET", "OUT", "NOV", "DEZ"]
            ...
            larg_graf, alt_max, X_GRAF, Y_GRAF = 480, 260, 57.5, 240
